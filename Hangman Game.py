...
class HangmanGame:
    def __init__(self, master):
        ...
        self.word_list = ["PYTHON", "JAVASCRIPT", "KOTLIN", "JAVA", "RUBY", "SWIFT","MOUSE","SUSHI"]
    ...
    def display_game_over_message(self, message):
        ...
        self.game_over_label = tk.Label(self.master, text=message, font=stylish_font, fg="#4a7a8c", bg='white')
